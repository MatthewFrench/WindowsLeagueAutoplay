...
namespace DesktopDuplication
{
    ...
    public class DesktopDuplicator
    {
        ...
        private bool RetrieveFrame()
        {
            ...
            try
            {
                mDeskDupl.AcquireNextFrame(60, out frameInfo, out desktopResource);
            }
            catch (SharpDXException ex)
            {
        ...
        public DataBox getCurrentDataBoxBytes()
        {
            return mDevice.ImmediateContext.MapSubresource(desktopImageTexture, 0, MapMode.Read, MapFlags.None);
        }
        public void releaseCurrentDataBoxBytes()
        {
        ...
        {
            return mOutputDesc.DesktopBounds.Width;
        }
        public int getFrameHeight()
        {
            return mOutputDesc.DesktopBounds.Height;
        }
        ...
        private void ProcessFrame(DesktopFrame frame)
        {
            ...
            DataBox mapSource = getCurrentDataBoxBytes();
          
            FinalImage = getImageFromDataBox(mapSource);
            releaseCurrentDataBoxBytes();
