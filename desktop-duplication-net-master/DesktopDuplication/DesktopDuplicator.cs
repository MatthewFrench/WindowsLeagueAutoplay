    ...
    public class DesktopDuplicator
    {
        ...
        public DesktopDuplicator(int whichMonitor)
            ...
            unsafe
            {
                ...
                Bitmap image = new Bitmap(Image.FromFile(Path.Combine(dir, "AnalysisImages\\Resources\\Test Images\\Test Level Up.png")));
                processDetection(getBytesForBitmap(image), image.Width, image.Height);
            }
